    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 to-blue-900 text-gray-100 font-sans">
      <div className="container mx-auto px-4 py-16">
        <header className="text-center mb-16">
          <h1 className="text-5xl font-bold mb-4 text-blue-300">Java Programming Course</h1>
          <p className="text-xl text-gray-300">Master the art of Java development</p>
        </header>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between mb-16">
          ...
          <div className="w-full md:w-1/2 md:pl-8">
            <h2 className="text-3xl font-semibold mb-4 text-blue-300">Course Overview</h2>
