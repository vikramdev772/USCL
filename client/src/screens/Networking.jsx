      ...
      <div className="absolute flex items-center justify-end px-4 z-10">
        ...
        <div className="md:flex">
          <div className="md:flex-shrink-0">
            <img
              className="h-90 w-full object-cover md:w-90 opacity-50"
          ...
          <div className="p-8">
            ...
            <p className="mt-4 text-xl text-gray-300 leading-8">
              Explore the fundamentals and advanced concepts of networking. Gain
              hands-on experience with modern networking technologies,
